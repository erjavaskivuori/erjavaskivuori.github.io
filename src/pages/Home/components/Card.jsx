...
const Card = ({ title, description, link, linkText, link2, linkText2, openNew }) => {
  return (
    <div className="bg-gray flex flex-col justify-between rounded-lg p-6 shadow">
      ...
      <div>
        <a
          ...
          className="button-color button-hover inline-flex items-center self-start rounded-lg px-3 py-2 text-center text-sm font-medium text-white mr-5"
        >
          {linkText}
          <svg
